...
def click_images(image):
    ...
    icon1 = pyautogui.locateCenterOnScreen(image, confidence=0.9)
    if icon1:
        pyautogui.moveTo(icon1, duration=random.uniform(0.3, 1.0))
        pyautogui.click(icon1)
        print(f"Clicked at position {icon1}.")
        time.sleep(
...
def click_logs_image():
    """Click on the logs image."""
    icon1 = pyautogui.locateCenterOnScreen("MahogLog.PNG", confidence=0.9)
    if icon1:
        pyautogui.moveTo(icon1, duration=random.uniform(0.3, 1.0))
        pyautogui.click(icon1)
...
def click_spell_image():
    """Click on the logs image."""
    icon1 = pyautogui.locateCenterOnScreen("Spell1.PNG", confidence=0.9)
    if icon1:
        pyautogui.moveTo(icon1, duration=random.uniform(0.3, 1.0))
        pyautogui.click(icon1)
        print(f"Clicked on 'Spell' at position {icon1}.")
        time.sleep(
            random.uniform(0.5, 1.5)
        )  # Pause for a random interval after clicking
...
if __name__ == "__main__":
    for i in range(15):  # Loop 10 times
